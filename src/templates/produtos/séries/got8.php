...
<html lang="pt-BR">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Game Of Thrones (8ª temporada)</title>
        <link rel="shortcut icon" href="../../../../assets/images/icons/logo_icone.svg" type="image/svg" />
        <meta name="description" content="Game Of Thrones (8ª temporada)" />
        <meta name="keywords" content="cinema loja serie dragões hbo época game of thrones arya" />
    ...
    <body id="topo">
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo">
                 <p style="text-align: center;">Game Of Thrones (8ª temporada)</p>
                    <div class="pri_col">
                    ...
                    <div class="seg_col">
                        <div class="card">
                            ...
                            <div class="card-body" style="background-color: #81b3ac;">
                                <h5 class="card-title">Preço: R$ 64,99</h5>
                                <form> 
                                      <label class="form-label" >Frete: R$ 5,99 </label><br />
                    ...
                    <div class="ter_col">
                        <table class="table caption-top table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr scope="row">
                                    <td>Diretor do seriado</td>
                                    <td>David Benioff , D.B. Weiss , David Nutter e Miguel Sapochnik</td>
                                </tr>
                                <tr scope="row">
                                    <td>Temporadas</td>
                                    <td>1</td>
