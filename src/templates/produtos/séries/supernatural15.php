...
<html lang="pt-BR">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Supernatural (15ª temporada)</title>
        <link rel="shortcut icon" href="../../../../assets/images/icons/logo_icone.svg" type="image/svg" />
        <meta name="description" content="Supernatural (15ª temporada)!" />
        <meta name="keywords" content="cinema loja series supernatural temporada dean winchester demonios" />
    ...
    <body id="topo">
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo">
		    <p style="text-align: center;">Supernatural (15ª temporada)</p>
                    <div class="pri_col">
                    ...
                    <div class="seg_col">
                        <div class="card">
                            ...
                            <div class="card-body" style="background-color: #81b3ac;">
                                <h5 class="card-title">Preço: R$ 34,80</h5
                                <form>
                    ...
                    <div class="ter_col">
                        <table class="table caption-top table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr scope="row">
                                    <td>Formato do seriado</td>
                                    <td>MKV</td>
                                </tr>
				<tr scope="row">
                                    <td>Sinopse</td>
                                    <td>A épica jornada dos irmãos Winchester finalmente chega ao fim na última temporada de Supernatural. Sam (Jared Padalecki) e Dean (Jensen Ackles) lutaram com demônios e anjos, criaturas místicas e monstros, numa aparentemente inacabável batalha para salvar o mundo. Mas agora, eles terão que enfrentar o próprio Deus (Rob Benedict).</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
