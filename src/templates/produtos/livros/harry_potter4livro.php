...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta name="description" content="Harry Potter e o Cálice de Fogo!" />
        <meta name="keywords" content="cinema loja livro franquias saga harry potter magia" />
    ...
    <body id="topo">
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo">
                    <p style="text-align: center;">Harry Potter e o Cálice de Fogo</p>
                    <div class="pri_col">
                    ...
                    <div class="seg_col">
                        <div class="card-header">
                            ...
                            <div class="card-body" style="background-color: #81b3ac;">
                                <h5 class="card-title">Preço: R$ 53,90</h5>
                                <form> 
