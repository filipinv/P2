...
<html lang="pt-BR">
    ...
    <head>
        ...
        <meta name="description" content="It - A Coisa" />
        <meta name="keywords" content="cinema loja livro cultura terror stephen king" />
    ...
    <body id="topo">
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo">
                    <p style="text-align: center;">It - A Coisa</p>
                    <div class="pri_col">
                    ...
                    <div class="seg_col">
                        <div class="card">
                            ...
                            <div class="card-body" style="background-color: #81b3ac;">
                                <h5 class="card-title">Preço: R$ 119,99</h5>
                                <form> 
