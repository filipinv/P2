...
<html lang="pt-BR">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Cine World - Filmes</title>
        <link rel="shortcut icon" href="../../../assets/images/icons/logo_icone.svg" type="image/svg" />
        <meta name="description" content="Escolha o filme que mais é a sua cara!" />
        <meta name="keywords" content="filmes produto aluguel clássicos nostálgico" />
        ...
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo" class="prod liv">
                    <p style="text-align: center;">Filmes</p>
                    <div id="pri_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Duro de Matar</h5>
                                <img src="../../../assets/images/products/filmes/duro_matar.jpg" type="image/jpg" alt="Duro de Matar" />
                                <p class="card-text">Assista agora!<p>
                                <a href="filmes/duro_%20de_%20matar.php" class="btn">Detalhes</a>
                            </div>
                        </div>
                    </div>
                    <div id="seg_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Piratas do caribe: A Maldição do Pérola Negra</h5>
                                <img src="../../../assets/images/products/filmes/piratas1.jpg" type="image/jpg" alt="Tabuleiro Oriental" />
                                <p class="card-text">Assista agora!</p>
                                <a href="filmes/piratas_caribe.php" class="btn">Detalhes</a>
                            </div>
                        </div>
                    </div>
                    <div id="ter_col">
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                <h5 class="card-title">Harry Potter e o Prisioneiro de Askaban</h5>
                                <img src="../../../assets/images/products/filmes/harry3.jpg" type="image/jpg" alt="Harry Potter e o Prisioneiro de Askaban" />
                                 <p class="card-text">Assista agora!<p>
                                <a href="filmes/harry_potter3.php" class="btn">Detalhes</a>
                            </div>
                        </div>
                    </div>
                 </main> 
