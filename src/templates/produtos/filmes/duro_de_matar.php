...
<html lang="pt-BR">
    ...
    <body id="topo">
        <div class="container-fluid px-0">
            ...
            <main>
                <div id="conteudo">
                    <p style="text-align: center;">Duro de Matar</p>
                    <div class="pri_col">
                    ...
                    <div class="seg_col">
                        <div class="card">
                            ...
                            <div class="card-body" style="background-color: #81b3ac;">
                                <h5 class="card-title">Preço: R$ 24,99</h5>
                                <form> 
